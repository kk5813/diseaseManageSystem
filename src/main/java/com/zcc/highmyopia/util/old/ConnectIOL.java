...
/**
 *
 * 第三步  ConnectIOL 找iolmaster到testyandi
 * 下一步  ConnectOCT
 */

@Configuration      //1.主要用于标记配置类，兼备Component的效果。
//@EnableScheduling   // 2.开启定时任务
public class ConnectIOL {
//    @Scheduled(cron = "0 0 13 * * ?")
    private void iolmasterConnect() {
                //声明mysql对象
                Connection con1;
                //驱动程序名
                ...
                try {
                    ...
                    try {
                        ...
                        String sql = "select * from HIS_AEYK.V_MTW_EXAM where COST_STATUS = '计费' and (EXAMINE_ITEM_CODE = '310300045C' or EXAMINE_ITEM_CODE = '310300045F' or EXAMINE_ITEM_CODE = '20160504042448' or EXAMINE_ITEM_CODE = '20160504042519' or EXAMINE_ITEM_CODE = '20160504042448')";
//                        String sql = "select * from HIS_AEYK.V_MTW_EXAM where COST_STATUS = '计费'";
                        //3.ResultSet类，用来存放获取的结果集！！
                        Statement statement2 = con2.createStatement();
                        ResultSet rs = statement2.executeQuery(sql);

                        //OCT（视盘)
//                        String sql4 = "update caselist set IOLMaster = ? where only_id = ?";
