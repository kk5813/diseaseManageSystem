...
//        aiModelResultService.save(aiModelResult);
        for (List<DiagnoseResultEntity> diagnoseResultEntityList : diagnoseResultEntityLists) {
        ...
        System.out.println(diagnoseResultEntityLists);
        return Result.succ(diagnoseResultEntityLists);
    }
