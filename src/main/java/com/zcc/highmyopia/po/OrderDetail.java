...
public class OrderDetail implements Serializable {
    ...
    private Date cancelRefundDate;  // 退单日期
    private Long orderId;  // 订单ID,对应Recipe.OrderDetailId
    ...
    private Date skinEnterTime;  // 皮肤给药时间
    ...
    private Date billingTime;  // 开账时间
    private BigDecimal singleDose;  // 单次剂量
    private Integer refunder;  // 退款人ID
    private String skinTest;  // 皮肤测试
    private String adminRoute;  // 给药途径
    private String anesthesiaMode;  // 麻醉方式
    private Integer medicDays;  // 药品天数
    private String herbalRequestName;  // 中药请求名称
    private Integer execCombiSeq;  // 执行组合顺序
    private String dripSpeedName;  // 滴速名称
