 ...
 * under the License.
 */
// package com.aier.cloud.biz.client.demo;
...
public class SignUtil {
    ...
    public static String sign(String secret, String method, String path,
        ...
        try {
            ...
            return new String(Base64.encodeBase64(
                    hmacSha256.doFinal(buildHeaderStringToSign(method, headers, signHeaderPrefixList)
     ...
     * @return
     */
    private static String buildHeaderStringToSign(String method,Map<String, String> headers,
                                                  List<String> signHeaderPrefixList) {
    ...
    private static String buildHeaders(Map<String, String> headers, List<String> signHeaderPrefixList) {
        ...
        if (null != signHeaderPrefixList) {
            ...
            signHeaderPrefixList.add(SystemHeader.X_CA_HOSTID);
            signHeaderPrefixList.add(SystemHeader.X_CA_KEY);
            signHeaderPrefixList.add(SystemHeader.X_CA_NONCE);
            signHeaderPrefixList.add(SystemHeader.X_CA_TIMESTAMP);
            signHeaderPrefixList.add(SystemHeader.X_CA_VERSION);
            ...
            if (null != headers) {
                ...
                headers.put(SystemHeader.X_CA_SIGNATURE, signHeadersStringBuilder.toString());
            }
        }
     ...
     * @return
     */
//    public   static Mono<Void> authorizedRequest(ServerWebExchange exchange, GatewayFilterChain chain, String message, String status, String error) {
